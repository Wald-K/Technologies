...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "hello",
        "sources": [
            "/home/wald/Programowanie/Technologies/Cython/hello.pyx"
        ]
    },
    "module_name": "hello"
}
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyString_FormatSafe(__pyx_kp_s_Hellos_s, __pyx_v_name); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
