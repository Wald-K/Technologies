...
res = es.search(index = index_name , body={"query": {"term": {"name": "Waldemar Klimek"} }})   # select by equality
# res = es.search(index = index_name , body={"query": {"match": {'name': 'Klimek'} }}, size = 3)  # limit the number of results
